                ...
                <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-secondary-200 p-4 shadow-2xl z-20 animate-fade-in-up">
                    <div className="max-w-3xl mx-auto flex justify-between items-center">
                        ...
                        <div className="flex flex-col items-end gap-2">
                            <input
                                type="tel"
                                placeholder="Phone (Optional for bill)"
                                value={customerPhone}
                                onChange={(e) => setCustomerPhone(e.target.value)}
                                className="px-3 py-1.5 text-sm border border-secondary-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 shadow-sm w-44"
                            />
                            <button
                                ...
                                {isCheckingOut ? (
                                    <>
                                        <svg className="animate-spin -ml-1 mr-2 h-5 w-5 text-white" fill="none" viewBox="0 0 24 24">
                                            ...
                                            <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962A7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                        </svg>
                                        Processing...
                                    </>
                                ) : 'Pay Now'}
